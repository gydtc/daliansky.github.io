...
sudo diskutil mount disk5s1  # 挂载安装镜像的EFI分区
...
1. 开机按`F2`进入`BIOS`设置,光标移动到`Security`,点击`Set Supervisor Password`设置一个`BIOS`密码,输入两次相同的密码,点击`YES`保存
     ![XiaoMi-Bios1](http://7.daliansky.net/XiaoMi-Bios1.png)
       ![XiaoMi-Bios2](http://7.daliansky.net/XiaoMi-Bios2.png)
       `Supervisor Password`由`Not Installed`变为`Installed`

2. 关闭安全启动

![XiaoMi-Bios3](http://7.daliansky.net/XiaoMi-Bios3.png)
点击`Secure Boot Mode`,设置为`Disabled`关闭安全启动
![XiaoMi-Bios4](http://7.daliansky.net/XiaoMi-Bios4.png)
...
开机按`F12`键进入`Boot Manager`引导管理,选择`EFI USB Device`,回车![XiaoMi-Bios5](http://7.daliansky.net/XiaoMi-Bios5.png)

进入`Clover`主菜单
![XiaoMiCloverboot](http://7.daliansky.net/XiaoMiCloverboot.png)
...
![ParallelsPicture](http://7.daliansky.net/ParallelsPicture.png)
...
选择简体中文
![ParallelsPicture1](http://7.daliansky.net/ParallelsPicture1.png)

出现`macOS实用工具`界面,选择磁盘工具

### 磁盘工具

![ParallelsPicture0](http://7.daliansky.net/ParallelsPicture0.png)
选择`显示所有设备`:
![ParallelsPicture2](http://7.daliansky.net/ParallelsPicture2.png)
选择`SSD Media`,点击`抹掉`按钮,选择默认的`Mac OS扩展(日志型)`,将名称修改为`Macintosh HD`,点击`抹掉`按钮

 ***假设您的磁盘是空的且数据是已经备份过的,别怪我没提醒你!!!***

![ParallelsPicture6](http://7.daliansky.net/ParallelsPicture6.png)
抹盘成功后,它会自动生成一个200MB的EFI分区,这样做的好处是不会出现安装过程中的由于EFI分区尺寸小于200MB而引起的无法安装的错误.当然前提是你的磁盘中没有重要的数据,或者您的数据已经提前备份过了.
![ParallelsPicture7](http://7.daliansky.net/ParallelsPicture7.png)
...
![ParallelsPicture8](http://7.daliansky.net/ParallelsPicture8.png)
进入安装界面
![ParallelsPicture11](http://7.daliansky.net/ParallelsPicture11.png)
选择继续
![ParallelsPicture12](http://7.daliansky.net/ParallelsPicture12.png)
![ParallelsPicture13](http://7.daliansky.net/ParallelsPicture13.png)
点击同意,选择`Macintosh HD`
![ParallelsPicture 14](http://7.daliansky.net/ParallelsPicture 14.png)
选择安装
![ParallelsPicture 15](http://7.daliansky.net/ParallelsPicture 15.png)
期间,它会把USB安装盘上的安装文件预复制到要安装的系统分区里,这个过程在小米Pro的笔记本上它跑得飞快,数据复制完后,它会自动重启
![ParallelsPicture16](http://7.daliansky.net/ParallelsPicture16.png)
然后进行第二阶段的安装
...
![ParallelsPicture 17](http://7.daliansky.net/ParallelsPicture 17.png)
...
![Installer3](http://7.daliansky.net/Installer3.png)
首先让你选择国家,这里我选择中国
![Installer4](http://7.daliansky.net/Installer4.png)
点击`继续`,设置键盘

### 设置键盘

![Installer5](http://7.daliansky.net/Installer5.png)
这里询问你`是否传输信息到这台Mac`
...
![Installer6](http://7.daliansky.net/Installer6.png)
我选择`现在不传输任何信息`,点击`继续`

### Apple ID登录

![Installer7](http://7.daliansky.net/Installer7.png)
选择是否`使用您的Apple ID登录`,如何想现在就登录到`Apple ID`,请输入`Apple ID`和密码登录,否则选择`不登录`,进入系统后也可以设置登录到`iCloud`,点击`继续`
![Installer8](http://7.daliansky.net/Installer8.png)
阅读条款与条件,选择`同意`继续
![Installer9](http://7.daliansky.net/Installer9.png)
出现`创建电脑用户`的窗口,输入用户名和密码,点击`继续`

### 创建电脑用户

![Installer10](http://7.daliansky.net/Installer10.png)
系统会创建初始用户
![Installer11](http://7.daliansky.net/Installer11.png)
用户创建成功后,弹出`iCloud`的`正在设置用户`的窗口
![Installer12](http://7.daliansky.net/Installer12.png)
紧接着弹出设置`iClound钥匙串`的设置窗口,选择`稍候设置`,点击`继续`

### 设置iCloud钥匙串

![Installer13](http://7.daliansky.net/Installer13.png)
出现`快捷设置`,点击`继续`
...
![Installer14](http://7.daliansky.net/Installer14.png)
出现`iCloud中的所有文件`,如果你需要`将文稿和桌面上的文件储存在 iCloud Drive中`,请勾选,否则取消勾选,点击继续

### iCloud文件同步设置

![Installer16](http://7.daliansky.net/Installer16.png)
出现`FileVault磁盘加密`,如果你需要`打开 Filevault 磁盘加密`,请勾选,否则取消勾选,点击继续

### FileVault磁盘加密设置

![Installer17](http://7.daliansky.net/Installer17.png)
出现`正在设置您的Mac`,请稍候完成设置向导

### 设置向导完成

![Installer18](http://7.daliansky.net/Installer18.png)
出现桌面后,整个的安装向导就完成了.
![Installer19](http://7.daliansky.net/Installer19.png)
...
# EFI下载/更新：https://github.com/daliansky/XiaoMi-Pro
